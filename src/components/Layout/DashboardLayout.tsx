...
export const DashboardLayout: React.FC = () => {
    ...
    const { focusScore, bandPowers, sessionStats } = useMockData(isPlaying);
    ...
    return (
        <div className="h-screen w-screen bg-background text-white p-4 flex flex-col gap-4 overflow-hidden">
            ...
            <main className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 min-h-0">
                ...
                <div className="lg:col-span-2 bg-surface rounded-2xl overflow-hidden border border-white/5 relative h-full">
                    <FarmView
                        isPlaying={isPlaying}
